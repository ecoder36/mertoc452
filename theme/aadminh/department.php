            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                   ...
                   <?php require_once ("require/themepanel.php") ; ?>
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> departments Table
                        <small></small>
                    </h3>
                    <?php
                    ...
                    if(isset($_GET['deptdel'])){echo '<div class="alert alert-success ">
                            ...
                            <div class="portlet light portlet-fit bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    echo  "<tr>
                                                  <td> $user->id   </td>
                                                  <td  > $user->dept   </td>
                                                  <td> <a class=\"edit btn green btn-sm\" href=\"javascript:;\"> Edit </a> </td>
                                                  <td> <a class=\"delete1 btn red btn-sm\" href=\"savedept.php?del=$user->id&5945\" onclick=\"return confirm('Are you sure to delete this row ($user->dept) ?')\"> Delete </a> </td>
                                          </tr>";
                                          }
                                          ?>
