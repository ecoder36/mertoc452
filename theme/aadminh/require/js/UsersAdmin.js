var TableDatatablesEditable = function () {
    ...
    var handleTable = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[1].innerHTML = '<input name="name" type="text" class=" copy1 form-control input-small" value="' + aData[1] + '">';
        ...
        //    jqTds[4].innerHTML = '<input name="isadmin" type="text" class=" copy4 form-control input-small" value="' + aData[4] + '">';
            ...
            jqTds[4].innerHTML='<form clas="edit" action="saveuser.php?id='+aData[0]+'&859" method="post" ><input type="hidden" class="copy1" name="name" value="'+aData[1]+'"><input type="hidden" class="copy2" name="uname" value="'+aData[2]+'"><input type="hidden" class="copy3" name="password" value="'+aData[3]+'"><button type="submit" onclick="$(this).parent(\'form\').submit();" class="btn btn-primary">Save</button></form>',
