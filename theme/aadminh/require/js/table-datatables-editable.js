var TableDatatablesEditable = function () {
    var handleTable = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[8].innerHTML='<form class="edit" action="saveinfo.php?id='+aData[0]+'&859" method="post" ><input type="hidden" class="copy1" name="model" value="'+aData[1]+'"><input type="hidden" class="copy2" name="dno" value="'+aData[2]+'"><input type="hidden" class="copy3" name="floor" value="'+aData[3]+'"><input type="hidden" class="copy4" name="dept" value="'+aData[4]+'"><input type="hidden" class="copy5" name="section" value="'+aData[5]+'"><input type="hidden" class="copy6" name="ename" value="'+aData[6]+'"><input type="hidden" class="copy7" name="ext" value="'+aData[7]+'"><button type="submit" onclick="$(this).parent(\'form\').submit();" class="btn btn-primary">Save</button></form> ',
            ...
            $(".copy6").keyup(function(){ $(".copy6").val($(this).val()); });
            $(".copy7").keyup(function(){ $(".copy7").val($(this).val()); });
            $(".copy8").keyup(function(){ $(".copy8").val($(this).val()); });
