...
<?php 
 $title="نموذج الجرد" ;
require_once ("require/vheader.php") ; ?>
        <!-- BEGIN SIDEBAR -->
    ...
    <div class="page-content">
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption pull-right">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">نموذج الجرد  <i class="icon-settings font-green"></i></span>
                                    </div>
                                          ...
                                          <!--  <div class="alert alert-success display-hide">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4" dir="rtl">
                                                  الجهاز   <span class="required"> * </span>
                                      <?php
                                      require_once('db.php');
                                      require_once('uiAPI.php');
                                               $itypea =  items_geta('');
		...
		echo '<div class="alert alert-danger"><button class="close" data-close="alert"></button><strong>Error: </strong>'.$error.'</div>';
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4" dir="rtl">
                                                الإدارة <span class="required"> * </span>
                                            <?php
                                          ...
                                          echo " </select>" ;
                                            ...
                                            ?>
                                             ...
                                             <div class="form-group">
                                                <label class="control-label col-md-4">
                                                 ...
                                                 <div class="col-md-4" dir="rtl">
                                                     القسم <span class="required"> * </span> <input value="<?php echo @$_POST['section']; ?>" type="text" name="section" data-required="1" class="form-control" />
                                                    <span class="help-block" >مثال : الدعم الفني </span>
                                                 </div>
                                                 <label class="control-label col-md-0">
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-4">
                                                 ...
                                                 <div class="col-md-4" dir="rtl">
                                                    إسم الموظف <span class="required"> * </span>   <input type="text" value="<?php echo @$_POST['ename']; ?>" name="ename" data-required="1" class="form-control" />
                                                    <span class="help-block" > الإسم الثلاثي </span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4"  dir="rtl">
                                        ملاحظة  <span class="required"> </span>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-7 col-md-9">
                                                    <button type="reset" class="alt btn default">إلغاء</button>
